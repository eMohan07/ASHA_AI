...
export default function AuthNav() {
  ...
  if (loading) {
    return <div className="w-32 h-8 bg-gray-100 rounded-lg animate-pulse" />
  }
  ...
  return (
    <div className="flex items-center gap-2">
      <Link href="/login"
        className="px-4 py-1.5 text-sm font-medium text-green-700 border border-green-700 rounded-lg hover:bg-green-50 transition-colors">
        Login
      </Link>
      <Link href="/signup"
        className="px-4 py-1.5 text-sm font-medium text-white bg-green-700 rounded-lg hover:bg-green-800 transition-colors">
        Sign Up
      </Link>
    </div>
  )
